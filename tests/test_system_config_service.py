...
class SystemConfigServiceTestCase(unittest.TestCase):
    ...
    def test_get_config_preserves_labeled_select_options_and_enum_validation(self) -> None:
        ...
        self.assertEqual(report_language_schema["validation"]["enum"], ["zh", "en", "ko", "kr", "ko-KR"])
    ...
    def test_validate_accepts_report_language_korean_alias(self) -> None:
        validation = self.service.validate(items=[{"key": "REPORT_LANGUAGE", "value": "kr"}])
