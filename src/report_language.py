...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "market_outlook_heading": "市场展望",
        "short_term_label": "短期（1-3日）",
        "medium_term_label": "中期（1-2周）",
        "technical_analysis_heading": "技术面分析",
        "comprehensive_label": "综合",
        "ma_label": "均线",
        "volume_analysis_label": "量能",
        "pattern_label": "形态",
        "fundamental_analysis_heading": "基本面分析",
        "sector_position_label": "板块地位",
        "company_highlights_label": "公司亮点",
        "news_sentiment_heading": "消息面/情绪面",
        "news_summary_label": "新闻摘要",
        "market_sentiment_label": "市场情绪",
        "hot_topics_label": "相关热点",
        "comprehensive_analysis_heading": "综合分析",
    ...
    "en": {
        ...
        "market_outlook_heading": "Market Outlook",
        "short_term_label": "Short Term (1-3 days)",
        "medium_term_label": "Medium Term (1-2 weeks)",
        "technical_analysis_heading": "Technical Analysis",
        "comprehensive_label": "Overall",
        "ma_label": "Moving Averages",
        "volume_analysis_label": "Volume",
        "pattern_label": "Pattern",
        "fundamental_analysis_heading": "Fundamental Analysis",
        "sector_position_label": "Sector Position",
        "company_highlights_label": "Company Highlights",
        "news_sentiment_heading": "News / Sentiment",
        "news_summary_label": "News Summary",
        "market_sentiment_label": "Market Sentiment",
        "hot_topics_label": "Hot Topics",
        "comprehensive_analysis_heading": "Overall Analysis",
    ...
    "ko": {
        ...
        "reason_label": "판단 근거",
        "trend_analysis_heading": "추세 분석",
        "market_outlook_heading": "시장 전망",
        "short_term_label": "단기(1-3일)",
        "medium_term_label": "중기(1-2주)",
        "technical_analysis_heading": "기술적 분석",
        "comprehensive_label": "종합",
        "ma_label": "이동평균",
        "volume_analysis_label": "거래량",
        "pattern_label": "패턴",
        "fundamental_analysis_heading": "펀더멘털 분석",
        "sector_position_label": "섹터 내 위치",
        "company_highlights_label": "기업 하이라이트",
        "news_sentiment_heading": "뉴스/심리",
        "news_summary_label": "뉴스 요약",
        "market_sentiment_label": "시장 심리",
        "hot_topics_label": "관련 이슈",
        "comprehensive_analysis_heading": "종합 분석",
        "risk_warning_label": "리스크 경고",
        "search_performed_label": "웹 검색 수행",
        "data_sources_label": "데이터 출처",
        "analysis_error_label": "분석 오류",
    },
}
